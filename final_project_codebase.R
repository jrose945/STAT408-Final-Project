...
coef_table <- data.frame(
  ...
  Interpretation = c(
    ...
    "The average number of likes on a post per day changes by a factor of exp(-0.015629) = 0.9844925 for people posting mid-day than the evening", 
    "The average number of likes on a post per day changes by a factor of exp(-0.955991) = 0.3844310 for people posting in the morning than the evening", 
    "The average number of likes on a post per day changes by a factor of exp(0.050535) = 1.0518337 for people posting at night than the evening", 
    "The average number of likes on a post per day changes by a factor of exp(-0.566306) =  0.5676184 when a post is a quote compared to when it is not a quote", 
    "The average number of likes on a post per day changes by a factor of exp(-0.45312)=  0.6356387 when a post is a reply compared to when it is not a reply", 
    "The average number of likes on a post per day changes by a factor of exp(0.392499) =   1.4806764 when there is an additional retruth and the post is posted in the evening", 
    "The average number of likes on a post per day changes by a factor of exp(0.401430) =   1.4939595 when there is an additional retruth and the post is posted mid-day rather than the evening",
    "The average number of likes on a post per day changes by a factor of exp(0.572539) =   1.7727624 when there is an additional retruth and the post is posted in the morning rather than the evening", 
    "The average number of likes on a post per day changes by a factor of exp(0.385291) =   1.4700420 when there is an additional retruth and the post is posted in the morning rather than the evening"
  ),
